...
export class LandingComponent implements AfterViewInit {
  ...
  readonly roleCards: RoleCard[] = [
    ...
    {
      icon: 'medical_services', color: '#2E7D32',
      title: 'Bác sĩ',
  ...
  readonly featureTiles: FeatureTile[] = [
    { icon: 'folder_shared', color: '#EF6C00', title: 'Hồ sơ sức khỏe số hoá — Miễn phí', desc: 'Lưu trữ đầy đủ chỉ số sức khỏe, bệnh sử, dễ dàng theo dõi qua biểu đồ. Hoàn toàn miễn phí.' },
    ...
    { icon: 'vaccines', color: '#2E7D32', title: 'Theo dõi tiêm chủng', desc: 'Quản lý lịch tiêm theo từng mũi, cảnh báo khi quá hạn.' },
    { icon: 'notifications_active', color: '#EF6C00', title: 'Nhắc nhở thông minh', desc: 'Không bỏ lỡ lịch uống thuốc, lịch tiêm chủng hay lịch tái khám.' },
